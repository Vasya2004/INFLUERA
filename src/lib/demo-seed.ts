...
export function createDemoAppState(): AppState {
  ...
  return {
    ...
    ideas: [
      { id: "i1", title: "Топ 5 ошибок начинающих дизайнеров", description: "Разобрать самые частые ошибки, которые делают новички при старте", format: "Reels/Shorts/TikTok", priority: "высокий", status: "в работе", createdAt: new Date().toISOString(), platformId: "p2", tags: ["ux", "ошибки"] },
      ...
      { id: "i4", title: "Карусель: UX-законы которые нужно знать", description: "10 базовых законов UX в формате карусели — просто и наглядно", format: "карусель", priority: "средний", status: "превращена в публикацию", createdAt: new Date(new Date().setDate(new Date().getDate() - 5)).toISOString(), platformId: "p2", tags: ["карусель", "ux"] },
      { id: "i5", title: "Разбор портфолио подписчика", description: "Живой разбор работ — показать типичные ошибки и как их исправить", format: "видео", priority: "низкий", status: "отложена", createdAt: new Date(new Date().setDate(new Date().getDate() - 7)).toISOString(), platformId: "p3" },
